...
<main id="main" class="main">
    ...
    <section class="section">
        ...
        <div class="iconslist">
            ...
            <div class="icon">
                <i class="ri-add-box-line"></i>
                <div class="label"> <a href="student-result.php"> Student results</a> </div>
            </div>
            <div class="icon">
                <i class="ri-anchor-fill"></i>
                <div class="label"> <a href="execel.php">Download </a></div>
            </div>
            <div class="icon">
                <i class="ri-history-line"></i>
                <div class="label"><a href="upload.php"> Upload result</a></div>
            </div>
            <div class="icon">
                <i class="ri-file-add-line"></i>
                <div class="label"><a href="register-course.php">Register Course </a></div>
            </div>
