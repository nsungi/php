<?php
    ...
    if (isset($_SESSION['Uid'])) {
        ...
        if (isset($_POST['register'])) {
            ...
            $sql = "INSERT INTO student_marks (studentID, professorCourse, grade) VALUES ('$userID', '$program','null')";
...
<main id="main" class="main">
    ...
    <nav>
        ...
        <li class="breadcrumb-item active">Blank <div class="w3-panel"><?php echo $error['message'] ?></div></li>
        </ol>
    </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <h5 class="card-title">Register Course</h5>
                    <form action="register-Exam.php" method="post" enctype="multipart/form-data">
                        <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <select class="form-select" id="floatingSelect" aria-label="State" name="course">
                                <option selected>Select</option>
                                <?php
                                $opt = "SELECT pc.id AS professorCourseID, u.lastName AS professorLastName, c.Code AS courseCode
                                        FROM user u
                                ...
                                if ($optquery && mysqli_num_rows($optquery) > 0) {
                                    while ($d = mysqli_fetch_array($optquery)) {
                                ?>
                                <option value="<?php echo $d['professorCourseID']; ?>">
                                    <?php echo $d['professorLastName'] . " (" . $d['courseCode'] . ")"; ?>
                                </option>
                                <?php
                                    }
                                } else {
                            ...
                            <label for="floatingSelect">Course You Want to Register</label>
                        </div>
