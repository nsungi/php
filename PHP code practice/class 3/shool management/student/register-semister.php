...
if (isset($_SESSION['Uid'])) {
    ...
    if (isset($_POST['f5'])) {
        ...
        $sql = "INSERT INTO student_program (studentID, programID) VALUES ('$userID', '$program')";
...
<main id="main" class="main">
    ...
    <section class="section">
        ...
        <!-- update registration for the program -->
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-center">Register Program you want to study</h5>

                <!-- Floating Labels Form -->
                <form class="row-4 g-5" action="register-semister.php" method='post' enctype="multipart/form-data">
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelect" aria-label="State" name="program">
                            ...
                            <div style =" color: red;"><?php echo $error['programs'] ?></div>

                            </div>
                        </div>

                    <div class="text-center">
                        <button type="submit" class="btn btn-primary" name="f5">Submit</button>
