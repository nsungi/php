<?php
    ...
    $error = array('courseName'=>'', 'courseCode'=>'', 'message'=>'','newCourse'=>'', 'newCode'=>'','courseUpdate' =>'');
    // grabing data from the form
    if (isset($_POST['submit-register'])){

        // Handleling Validations
        if (empty($_POST['courseName'])){
            $error['courseName'] = "you didn't fill the Course name ";
        }else{
            $cName = $_POST['courseName'];
            }
        
        if (empty($_POST['courseCode'])){
            $error['courseCode'] = "you didn't fill the Course code ";
        }else{
        ...
        $sql = "INSERT INTO courses (courseName, Code) VALUES ('$cName', '$courseCode')";
...
if (isset($_POST['submit-update'])){
    ...
    // Handleling Validations
    if (empty($_POST['courseName'])){
        $error['newCourse'] = "you didn't fill the Course name ";
    }else{
        $cName = $_POST['courseName'];
        }
    
    if (empty($_POST['courseCode'])){
        $error['newCode'] = "you didn't fill the Course Code ";
    }else{
        $courseCode = $_POST['courseCode'];
        }

    if (empty($_POST['courseID'])){
        $error['courseUpdate'] = "you didn't fill the Couse to be updated ";
    }else{
    ...
    //Query creation for insert data
    $sql = "UPDATE `courses` SET `courseName` = '$cName', Code = '$courseCode' WHERE `courses`.`courseID` = '$courseID'";
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="maintain-course.php" method='post' enctype="multipart/form-data">
                
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatingPassword" placeholder="Course Name" name="courseName">
                            <label for="floatingPassword">Course Name</label>
                            <div style =" color: red;"><?php echo $error['courseName'] ?></div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatingPassword" placeholder="Course Code (CSS 321)" name="courseCode" >
                            <label for="floatingPassword">Course Code (CSS 321)</label>
                            <div style =" color: red;"><?php echo $error['courseCode'] ?></div>
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row-4 g-5" action="maintain-course.php" method='post' enctype="multipart/form-data">
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                                ...
                                <div style =" color: red;"><?php echo $error['courseUpdate'] ?></div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="form-floating mb-3">
                            ...
                            <label for="floatingPassword">New Course Name</label>
                            <div style =" color: red;"><?php echo $error['newCourse'] ?></div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingPassword" placeholder="Course Code (CSS 321)" name="courseCode" >
                            <label for="floatingPassword">Course Code (CSS 321)</label>
                            <div style =" color: red;"><?php echo $error['newCode'] ?></div>
                        </div>
                    </div>
