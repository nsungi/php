...
<div id="body">
    ...
    <div class="rcontent">
		...
		if(isset($_GET['success'])){
				...
				$result=mysqli_query($connect,"INSERT INTO customer VALUES(NULL,'{$_POST['fname']}','{$_POST['lname']}','{$_POST['cjoindate']}',{$_POST['cmoneyspent']},'{$_POST['caddress']}',{$_POST['cmoney_spent_reset']},{$_POST['cphone']})");
				...
				echo "<form method='post' action='addcustomer.php?success=1'>
					<table>
						...
						<tr><td style='padding:5px'>Phone no.</td><td><input type='text' placeholder='+255..' name='cphone' /></td></tr>
